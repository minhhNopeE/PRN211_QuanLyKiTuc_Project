...
namespace QuanLyKyTucXa
{
    public partial class FrmQuanLyPhong : Form
    {
        ...
        DAO.DAO_Phong DAO = new DAO.DAO_Phong();
        DAO.DAO_Day DAODay = new DAO.DAO_Day();
        private void FrmQuanLyPhong_Load(object sender, EventArgs e)
        {
            cbDay.DataSource = DAODay.SelectMaDay();
            cbDay.ValueMember = "maday";
            dgvPhong.DataSource = DAO.SelectPhong();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            DAO.InsertPhong(txtMaphong.Text, txtTenphong.Text, txtSosvtoida.Text, cbLoaiphong.Text, cbXeploai.Text, cbDay.Text);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            DAO.UpdatePhong(txtMaphong.Text, txtTenphong.Text, int.Parse(txtSosvhientai.Text), int.Parse(txtSosvtoida.Text), cbLoaiphong.Text, cbXeploai.Text, cbDay.Text);
            btnCapnhat_Click(sender, e);
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                DAO.DeletePhong(txtMaphong.Text);
                btnCapnhat_Click(sender, e);
            }
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvPhong.DataSource = DAO.SearchPhong(txtTimkiem.Text, "maphong");
            }
            else if (rbTktheoten.Checked)
            {
                dgvPhong.DataSource = DAO.SearchPhong(txtTimkiem.Text, "tenphong");
            }
            else if (rbTkTheoMaday.Checked)
            {
                dgvPhong.DataSource = DAO.SearchPhong(txtTimkiem.Text, "day");
            }
            else
            {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox1.Checked == true)
                dgvPhong.DataSource = DAO.SelectPhongTrong();
            else
                dgvPhong.DataSource = DAO.SelectPhong();
        }
