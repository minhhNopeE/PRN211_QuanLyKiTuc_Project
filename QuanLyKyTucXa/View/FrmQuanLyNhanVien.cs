...
namespace QuanLyKyTucXa
{
    public partial class FrmQuanLyNhanVien : Form
    {
        ...
        {
            dgvNhanvien.DataSource = DAO.SelectNhanVien();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            DAO.InsertNhanVien(txtManv.Text, txtTennv.Text, cbGioitinh.Text, dtpNgaysinh.Value, txtDiachi.Text, txtSodienthoai.Text, float.Parse(txtHesoluong.Text));
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            DAO.UpdateNhanVien(txtManv.Text, txtTennv.Text, cbGioitinh.Text, dtpNgaysinh.Value, txtDiachi.Text, txtSodienthoai.Text, float.Parse(txtHesoluong.Text));
            btnCapnhat_Click(sender, e);
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                DAO.DeleteNhanVien(txtManv.Text);
                btnCapnhat_Click(sender, e);
            }
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvNhanvien.DataSource = DAO.SearchNhanVien(txtTimkiem.Text, "manv");
            }
            else if (rbTktheoten.Checked)
            {
                dgvNhanvien.DataSource = DAO.SearchNhanVien(txtTimkiem.Text, "tennv");
            }
            else
            {
