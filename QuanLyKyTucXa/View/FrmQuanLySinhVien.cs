...
namespace QuanLyKyTucXa
{
    public partial class FrmQuanLySinhVien : Form
    {
        ...
        private void FormQuanLySinhVien_Load(object sender, EventArgs e)
        {
            ...
            dgvSinhvien.DataSource = DAO.SelectSinhVien();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            DAO.InsertSinhVien(txtMasv.Text, txtTensv.Text, cbGioitinh.Text, dtpNgaysinh.Value, txtQuequan.Text, cbKhoa.Text, txtLop.Text, cbMaphong.Text, cbLoaiuutien.Text);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string maphongcu = DAO.SelectMaPhongCu(txtMasv.Text).Rows[0][0].ToString();
            DAO.UpdateSosvPhong(maphongcu, -1);
            DAO.UpdateSinhVien(txtMasv.Text, txtTensv.Text, cbGioitinh.Text, dtpNgaysinh.Value, txtQuequan.Text, cbKhoa.Text, txtLop.Text, cbMaphong.Text, cbLoaiuutien.Text);
            DAO.UpdateSosvPhong(cbMaphong.Text, 1);
            btnCapnhat_Click(sender, e);
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                DAO.DeleteSinhVien(txtMasv.Text);
                btnCapnhat_Click(sender, e);
            }
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvSinhvien.DataSource = DAO.SearchSinhVien(txtTimkiem.Text, "masv");
            }
            else if (rbTktheoten.Checked)
            {
                dgvSinhvien.DataSource = DAO.SearchSinhVien(txtTimkiem.Text, "tensv");
            }
            else if (rbTkTheoMaphong.Checked)
            {
                dgvSinhvien.DataSource = DAO.SearchSinhVien(txtTimkiem.Text, "maphong");
            }
            else
            {
